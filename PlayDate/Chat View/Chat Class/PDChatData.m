...
@synthesize guardian_id = _guardian_id;
...
- (void)messageInputView:(SOMessageInputView *)inputView didSendMessage:(NSString *)message
{
    ...
    [[[PDHelper sharedHelper] recentArray] addObject:self.guardian_id];
    NSLog(@"%d",[[[PDHelper sharedHelper] recentArray]count]);
