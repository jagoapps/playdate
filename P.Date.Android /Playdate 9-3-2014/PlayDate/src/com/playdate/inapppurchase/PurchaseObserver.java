...
public abstract class PurchaseObserver {
    ...
    private Object[] mStartIntentSenderArgs = new Object[6];
    private static final Class[] START_INTENT_SENDER_SIG = new Class[] {
        IntentSender.class,int.class, Intent.class, int.class, int.class, int.class
    };
    ...
    private void initCompatibilityLayer() {
        try {
            mStartIntentSender = mActivity.getClass().getMethod("startIntentSenderForResult",
    ...
    void startBuyPageActivity(PendingIntent pendingIntent, Intent intent) {
        if (mStartIntentSender != null) {
            ...
            try {
                ...
                mStartIntentSenderArgs[1] = Integer.valueOf(1001);
                mStartIntentSenderArgs[2] = intent;
                mStartIntentSenderArgs[3] = Integer.valueOf(0);
                mStartIntentSenderArgs[4] = Integer.valueOf(0);
                mStartIntentSenderArgs[5] = Integer.valueOf(0);
