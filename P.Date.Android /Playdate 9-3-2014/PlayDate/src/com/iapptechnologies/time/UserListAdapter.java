		...
		public void onClick(View v) {
           ...
           int i1 = 0;
			...
			if(phonenumber_sms.equals(null)||phonenumber_sms.equals("")){
				...
				System.out.println(phonenumber_sms);
				/*String message_trim="";
                ...
                if(message_trim.equals(null)||message_trim.equals("")){
                	...
                	*/
                     ...
                     i.putExtra("sms_body", "I'm using a new app 'Playdate' to plan the kids schedule, join me by downloading at http://www.playdateapp.co <http://www.playdateapp.co/> it makes it easier & fun !!");
           ...
           /*    final Dialog dialog = new Dialog(context);
                ...
                text.setText("I'm using a new app 'Playdate' to plan the kids schedule, join me by downloading at http://www.playdateapp.co <http://www.playdateapp.co/> it makes it easier & fun !!");
